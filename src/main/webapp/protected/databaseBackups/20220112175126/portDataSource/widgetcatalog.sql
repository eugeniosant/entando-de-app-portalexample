INSERT INTO widgetcatalog (code,titles,parameters,plugincode,parenttypecode,defaultconfig,locked,maingroup,configui,bundleid,readonlypagewidgetconfig,widgetcategory,icon) VALUES ('entando-widget-navigation_breadcrumbs','<?xml version="1.0" encoding="UTF-8"?>
<properties>
...
INSERT INTO widgetcatalog (code,titles,parameters,plugincode,parenttypecode,defaultconfig,locked,maingroup,configui,bundleid,readonlypagewidgetconfig,widgetcategory,icon) VALUES ('entando-widget-navigation_bar','<?xml version="1.0" encoding="UTF-8"?>
<properties>
...
</config>',NULL,NULL,NULL,1,'free',NULL,NULL,NULL,NULL,NULL);
INSERT INTO widgetcatalog (code,titles,parameters,plugincode,parenttypecode,defaultconfig,locked,maingroup,configui,bundleid,readonlypagewidgetconfig,widgetcategory,icon) VALUES ('entando-widget-navigation_menu','<?xml version="1.0" encoding="UTF-8"?>
<properties>
...
</config>','jacms',NULL,NULL,1,'free',NULL,NULL,NULL,NULL,NULL);
INSERT INTO widgetcatalog (code,titles,parameters,plugincode,parenttypecode,defaultconfig,locked,maingroup,configui,bundleid,readonlypagewidgetconfig,widgetcategory,icon) VALUES ('URP_Public_Relations_Office','<?xml version="1.0" encoding="UTF-8"?>
<properties>
...
</properties>',0,'free',NULL,NULL,NULL,NULL,NULL);
INSERT INTO widgetcatalog (code,titles,parameters,plugincode,parenttypecode,defaultconfig,locked,maingroup,configui,bundleid,readonlypagewidgetconfig,widgetcategory,icon) VALUES ('ANN_Archive','<?xml version="1.0" encoding="UTF-8"?>
<properties>
...
INSERT INTO widgetcatalog (code,titles,parameters,plugincode,parenttypecode,defaultconfig,locked,maingroup,configui,bundleid,readonlypagewidgetconfig,widgetcategory,icon) VALUES ('ANN_Latest','<?xml version="1.0" encoding="UTF-8"?>
<properties>
...
INSERT INTO widgetcatalog (code,titles,parameters,plugincode,parenttypecode,defaultconfig,locked,maingroup,configui,bundleid,readonlypagewidgetconfig,widgetcategory,icon) VALUES ('entando-widget-language_choose','<?xml version="1.0" encoding="UTF-8"?>
<properties>
...
INSERT INTO widgetcatalog (code,titles,parameters,plugincode,parenttypecode,defaultconfig,locked,maingroup,configui,bundleid,readonlypagewidgetconfig,widgetcategory,icon) VALUES ('card_list','<?xml version="1.0" encoding="UTF-8"?>
<properties>
<property key="en">Personal Cards - List</property>
<property key="it">Personal Card - Lista</property>
</properties>',NULL,NULL,NULL,NULL,1,'free',NULL,NULL,NULL,NULL,NULL);
INSERT INTO widgetcatalog (code,titles,parameters,plugincode,parenttypecode,defaultconfig,locked,maingroup,configui,bundleid,readonlypagewidgetconfig,widgetcategory,icon) VALUES ('card_list_detail','<?xml version="1.0" encoding="UTF-8"?>
<properties>
...
</properties>',1,'free',NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO widgetcatalog (code,titles,parameters,plugincode,parenttypecode,defaultconfig,locked,maingroup,configui,bundleid,readonlypagewidgetconfig,widgetcategory,icon) VALUES ('RSL_Latest','<?xml version="1.0" encoding="UTF-8"?>
<properties>
...
</properties>',1,NULL,NULL,NULL,NULL,NULL,NULL);
...
</properties>',NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL);
...
</properties>',NULL,'jacms',NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL);
...
</config>',NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO widgetcatalog (code,titles,parameters,plugincode,parenttypecode,defaultconfig,locked,maingroup,configui,bundleid,readonlypagewidgetconfig,widgetcategory,icon) VALUES ('entando-widget-search_form','<?xml version="1.0" encoding="UTF-8"?>
<properties>
<property key="en">Search Form</property>
<property key="it">Search Form</property>
</properties>',NULL,NULL,NULL,NULL,1,'free',NULL,NULL,NULL,NULL,NULL);
INSERT INTO widgetcatalog (code,titles,parameters,plugincode,parenttypecode,defaultconfig,locked,maingroup,configui,bundleid,readonlypagewidgetconfig,widgetcategory,icon) VALUES ('RSL_Archive','<?xml version="1.0" encoding="UTF-8"?>
<properties>
...
INSERT INTO widgetcatalog (code,titles,parameters,plugincode,parenttypecode,defaultconfig,locked,maingroup,configui,bundleid,readonlypagewidgetconfig,widgetcategory,icon) VALUES ('entando-widget-login_form','<?xml version="1.0" encoding="UTF-8"?>
<properties>
