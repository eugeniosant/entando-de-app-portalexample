...
INSERT INTO guifragment (code,widgettypecode,plugincode,gui,defaultgui,locked) VALUES ('entando-widget-navigation_menu_include',NULL,NULL,NULL,'<#assign wp=JspTaglibs["/aps-core"]>
...
<@wp.outputHeadInfo type="JS">
	<script src="<@wp.resourceURL />static/js/<@wp.printHeadInfo />" nonce="<@wp.cspNonce />" ></script>
</@wp.outputHeadInfo>

<#-- external/CDN js scripts (remember to include the libraries first) -->
<@wp.outputHeadInfo type="JS_EXT">
	<script src="<@wp.printHeadInfo />" nonce="<@wp.cspNonce />" ></script>
</@wp.outputHeadInfo>
...
<script src="<@wp.resourceURL />static/js/entando-misc-less/less-1.3.1.min.js" nonce="<@wp.cspNonce />" ></script>',NULL,0);
...
<a href="<@wp.action path="/ExtStr2/do/FrontEnd/Card/list.action" />" class="btn"><@wp.i18n key="BACK_TO_CARDS_LIST" /></a>',1);
...
INSERT INTO guifragment (code,widgettypecode,plugincode,gui,defaultgui,locked) VALUES ('portalexample_card_cardFinding','card_list',NULL,NULL,'<#assign wp=JspTaglibs["/aps-core"]>
